...
const Domestic = () => {
  const reasons = [
   ...
   const handleCardClick = (index) => {
     // If the clicked card is already the one clicked, reset it
...
<div className="b2b-section">
      <div className="b2b-content">
        ...
        {/* <div className="logos">
          <img src="/path/to/soothe-logo.png" alt="Soothe" />
          <img src="/path/to/tata-logo.png" alt="Tata Consumer Products" />
    ...
    <div className="carousel-container">
      ...
      <div className="content">
        ...
        <div className="right-side">
          <h2>How It Works</h2>
          <ol>
            <li><strong>Schedule a Pickup:</strong> Easily schedule a pickup online, by phone, or through our app. Provide us with the necessary details, and we'll handle the rest.</li>
            <li><strong>Track Your Shipment:</strong> Use our real-time tracking system to monitor your package’s journey. You’ll receive updates at every stage of the delivery process.</li>
            <li><strong>Delivery Confirmation:</strong> Once delivered, you’ll receive a confirmation notification, ensuring peace of mind that your shipment has arrived safely.</li>
          </ol>
          <h3>Get Started Today</h3>
          <p>Whether you're a business or an individual, Ease My Shipping is here to meet all your domestic courier needs. Experience the convenience, reliability, and efficiency of our services.</p>
          <p>Contact us today to learn more or to schedule your next delivery!</p>
        </div>
      </div>
    </div>
    </Homepage>
